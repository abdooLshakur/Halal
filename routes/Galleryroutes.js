...
router.post("/create-Gallery", Protected, upload.single('Gallery_img', 10), CreateGallery);
router.get("/Gallerys", getAllGallery);
router.put("/update-Gallery/:id", Protected, upload.single('Gallery_img', 10), updateGallery);
