...
router.post("/create-Gallery", Protected, uploads.array("Gallery_img", 10) , CreateGallery);
router.get("/Gallerys", getAllGallery);
router.put("/update-Gallery/:id", Protected, uploads.array("Gallery_img", 10) , updateGallery);
