...
router.post("/create-Gallery", Protected, upload.array("Gallery_img", 10) , CreateGallery);
router.get("/Gallerys", getAllGallery);
router.put("/update-Gallery/:id", Protected, upload.array("Gallery_img", 10) , updateGallery);
